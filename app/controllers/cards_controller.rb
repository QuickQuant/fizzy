class CardsController < ApplicationController
  wrap_parameters :card, include: %i[ title description image created_at last_active_at pipeline_metadata ]
  ...
  private
    ...
    def card_params
      params.expect(card: [ :title, :description, :image, :created_at, :last_active_at, pipeline_metadata: {} ])
    end
end
